...
public class UmaResource {
    ...
    @Schema(description = "A URI for a graphic icon representing the resource set. The referenced icon MAY be used by the authorization server in its resource owner user interface for the resource owner."
            , required = false)
    private String iconUri;

    @Schema(description = " A human-readable string describing a set of one or more resources. This name MAY be used by the authorization server in its resource owner user interface for the resource owner."
              , required = false)
    private String name;

    @Schema(description = " A string uniquely identifying the semantics of the resource set. For example, if the resource set consists of a single resource that is an identity claim that leverages standardized claim semantics for \"verified email address\", the value of this property could be an identifying URI for this claim."
                  , required = false)
    private String type;

    @Schema(description = "Integer timestamp, measured in the number of seconds since January 1 1970 UTC, indicating when this resource was originally issued.", required = true)
    private Integer iat;

    @Schema(description = " Integer timestamp, measured in the number of seconds since January 1 1970 UTC, indicating when this resource will expire. ", required = true)
    private Integer exp;
