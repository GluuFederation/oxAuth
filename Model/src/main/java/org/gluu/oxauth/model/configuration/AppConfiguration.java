...
public class AppConfiguration implements Configuration {
	...
	public DiffResult diff(Configuration newObj) {
		AppConfiguration obj = (AppConfiguration) newObj;
		 return new DiffBuilder(this, obj, ToStringStyle.SHORT_PREFIX_STYLE)
		.append("issuer", this.issuer, obj.issuer)
		.append("baseEndpoint", this.baseEndpoint, obj.baseEndpoint)
		.append("authorizationEndpoint", this.authorizationEndpoint, obj.authorizationEndpoint)
		.append("tokenEndpoint", this.tokenEndpoint, obj.tokenEndpoint)
		.append("tokenRevocationEndpoint", this.tokenRevocationEndpoint, obj.tokenRevocationEndpoint)
		.append("userInfoEndpoint", this.tokenRevocationEndpoint, obj.tokenRevocationEndpoint)
		.append("clientInfoEndpoint", this.clientInfoEndpoint, obj.clientInfoEndpoint)
		.append("checkSessionIFrame", this.checkSessionIFrame, obj.checkSessionIFrame)
		.append("endSessionEndpoint", this.endSessionEndpoint, obj.endSessionEndpoint)
		.append("jwksUri", this.jwksUri, obj.jwksUri)
		.append("registrationEndpoint", this.registrationEndpoint, obj.registrationEndpoint)
		.append("openIdDiscoveryEndpoint", this.openIdDiscoveryEndpoint, obj.openIdDiscoveryEndpoint)
		.append("openIdConfigurationEndpoint", this.openIdConfigurationEndpoint, obj.openIdConfigurationEndpoint)
		.append("idGenerationEndpoint", this.idGenerationEndpoint, obj.idGenerationEndpoint)
		.append("introspectionEndpoint", this.introspectionEndpoint, obj.introspectionEndpoint)
		.append("deviceAuthzEndpoint", this.deviceAuthzEndpoint, obj.deviceAuthzEndpoint)
		.append("discoveryCacheLifetimeInMinutes", this.discoveryCacheLifetimeInMinutes, obj.discoveryCacheLifetimeInMinutes)
		.append("sectorIdentifierCacheLifetimeInMinutes", this.sectorIdentifierCacheLifetimeInMinutes, obj.sectorIdentifierCacheLifetimeInMinutes)
		.append("sessionAsJwt", this.sessionAsJwt, obj.sessionAsJwt)
		.append("umaConfigurationEndpoint", this.umaConfigurationEndpoint, obj.umaConfigurationEndpoint)
		.append("umaRptAsJwt", this.umaRptAsJwt, obj.umaRptAsJwt)
		.append("umaRptLifetime", this.umaRptLifetime, obj.umaRptLifetime)
		.append("umaTicketLifetime", this.umaTicketLifetime, obj.umaTicketLifetime)
		.append("umaPctLifetime", this.umaPctLifetime, obj.umaPctLifetime)
		.append("umaResourceLifetime", this.umaResourceLifetime, obj.umaResourceLifetime)
		.append("umaAddScopesAutomatically", this.umaAddScopesAutomatically, obj.umaAddScopesAutomatically)
		.append("umaValidateClaimToken", this.umaValidateClaimToken, obj.umaValidateClaimToken)
		.append("umaGrantAccessIfNoPolicies", this.umaGrantAccessIfNoPolicies, obj.umaGrantAccessIfNoPolicies)
		.append("umaRestrictResourceToAssociatedClient", this.umaRestrictResourceToAssociatedClient, obj.umaRestrictResourceToAssociatedClient)
		.append("statEnabled = true", this.statEnabled, obj.statEnabled)
		.append("statAuthorizationScope", this.statAuthorizationScope, obj.statAuthorizationScope)
		.append("statTimerIntervalInSeconds", this.statTimerIntervalInSeconds, obj.statTimerIntervalInSeconds)
		.append("statWebServiceIntervalLimitInSeconds", this.statWebServiceIntervalLimitInSeconds, obj.statWebServiceIntervalLimitInSeconds)
		.append("allowSpontaneousScopes", this.allowSpontaneousScopes, obj.allowSpontaneousScopes)
		.append("spontaneousScopeLifetime", this.spontaneousScopeLifetime, obj.spontaneousScopeLifetime)
		.append("openidSubAttribute", this.openidSubAttribute, obj.openidSubAttribute)
		.append("responseTypesSupported", this.responseTypesSupported, obj.responseTypesSupported)
		.append("responseModesSupported", this.responseModesSupported, obj.responseModesSupported)
		.append("grantTypesSupported", this.grantTypesSupported, obj.grantTypesSupported)
		.append("subjectTypesSupported", this.subjectTypesSupported, obj.subjectTypesSupported)
		.append("defaultSubjectType", this.defaultSubjectType, obj.defaultSubjectType)
		.append("userInfoSigningAlgValuesSupported", this.userInfoSigningAlgValuesSupported, obj.userInfoSigningAlgValuesSupported)
		.append("userInfoEncryptionAlgValuesSupported", this.userInfoEncryptionAlgValuesSupported, obj.userInfoEncryptionAlgValuesSupported)
		.append("userInfoEncryptionEncValuesSupported", this.userInfoEncryptionEncValuesSupported, obj.userInfoEncryptionEncValuesSupported)
		.append("idTokenSigningAlgValuesSupported", this.idTokenSigningAlgValuesSupported, obj.idTokenSigningAlgValuesSupported)
		.append("idTokenEncryptionAlgValuesSupported", this.idTokenEncryptionAlgValuesSupported, obj.idTokenEncryptionAlgValuesSupported)
		.append("idTokenEncryptionEncValuesSupported", this.idTokenEncryptionEncValuesSupported, obj.idTokenEncryptionEncValuesSupported)
		.append("requestObjectSigningAlgValuesSupported", this.requestObjectSigningAlgValuesSupported, obj.requestObjectSigningAlgValuesSupported)
		.append("requestObjectEncryptionAlgValuesSupported", this.requestObjectEncryptionAlgValuesSupported, obj.requestObjectEncryptionAlgValuesSupported)
		.append("requestObjectEncryptionEncValuesSupported", this.requestObjectEncryptionEncValuesSupported, obj.requestObjectEncryptionEncValuesSupported)
		.append("tokenEndpointAuthMethodsSupported", this.tokenEndpointAuthMethodsSupported, obj.tokenEndpointAuthMethodsSupported)
		.append("tokenEndpointAuthSigningAlgValuesSupported", this.tokenEndpointAuthSigningAlgValuesSupported, obj.tokenEndpointAuthSigningAlgValuesSupported)
		.append("dynamicRegistrationCustomAttributes", this.dynamicRegistrationCustomAttributes, obj.dynamicRegistrationCustomAttributes)
		.append("displayValuesSupported", this.displayValuesSupported, obj.displayValuesSupported)
		.append("claimTypesSupported", this.claimTypesSupported, obj.claimTypesSupported)
		.append("jwksAlgorithmsSupported", this.jwksAlgorithmsSupported, obj.jwksAlgorithmsSupported)
		.append("serviceDocumentation", this.serviceDocumentation, obj.serviceDocumentation)
		.append("claimsLocalesSupported", this.claimsLocalesSupported, obj.claimsLocalesSupported)
		.append("idTokenTokenBindingCnfValuesSupported", this.idTokenTokenBindingCnfValuesSupported, obj.idTokenTokenBindingCnfValuesSupported)
		.append("uiLocalesSupported", this.uiLocalesSupported, obj.uiLocalesSupported)
		.append("claimsParameterSupported", this.claimsParameterSupported, obj.claimsParameterSupported)
		.append("requestParameterSupported", this.requestParameterSupported, obj.requestParameterSupported)
		.append("requestUriParameterSupported", this.requestUriParameterSupported, obj.requestUriParameterSupported)
		.append("requestUriHashVerificationEnabled", this.requestUriHashVerificationEnabled, obj.requestUriHashVerificationEnabled)
		.append("requireRequestUriRegistration", this.requireRequestUriRegistration, obj.requireRequestUriRegistration)
		.append("requestUriBlockList", this.requestUriBlockList, obj.requestUriBlockList)
		.append("opPolicyUri", this.opPolicyUri, obj.opPolicyUri)
		.append("opTosUri", this.opTosUri, obj.opTosUri)
		.append("authorizationCodeLifetime", this.authorizationCodeLifetime, obj.authorizationCodeLifetime)
		.append("refreshTokenLifetime", this.refreshTokenLifetime, obj.refreshTokenLifetime)
		.append("idTokenLifetime", this.idTokenLifetime, obj.idTokenLifetime)
		.append("accessTokenLifetime", this.accessTokenLifetime, obj.accessTokenLifetime)
		.append("cleanServiceInterval", this.cleanServiceInterval, obj.cleanServiceInterval)
		.append("cleanServiceBatchChunkSize", this.cleanServiceBatchChunkSize, obj.cleanServiceBatchChunkSize)
		.append("keyRegenerationEnabled", this.keyRegenerationEnabled, obj.keyRegenerationEnabled)
		.append("keyRegenerationInterval", this.keyRegenerationInterval, obj.keyRegenerationInterval)
		.append("defaultSignatureAlgorithm", this.defaultSignatureAlgorithm, obj.defaultSignatureAlgorithm)
		.append("oxOpenIdConnectVersion", this.oxOpenIdConnectVersion, obj.oxOpenIdConnectVersion)
		.append("oxId", this.oxId, obj.oxId)
		.append("dynamicRegistrationEnabled", this.dynamicRegistrationEnabled, obj.dynamicRegistrationEnabled)
		.append("dynamicRegistrationExpirationTime", this.dynamicRegistrationExpirationTime, obj.dynamicRegistrationExpirationTime)
		.append("dynamicRegistrationPersistClientAuthorizations", this.dynamicRegistrationPersistClientAuthorizations, obj.dynamicRegistrationPersistClientAuthorizations)
		.append("trustedClientEnabled", this.trustedClientEnabled, obj.trustedClientEnabled)
		.append("skipAuthorizationForOpenIdScopeAndPairwiseId", this.skipAuthorizationForOpenIdScopeAndPairwiseId, obj.skipAuthorizationForOpenIdScopeAndPairwiseId)
		.append("dynamicRegistrationScopesParamEnabled", this.dynamicRegistrationScopesParamEnabled, obj.dynamicRegistrationScopesParamEnabled)
		.append("dynamicRegistrationPasswordGrantTypeEnabled = false", this.dynamicRegistrationPasswordGrantTypeEnabled, obj.dynamicRegistrationPasswordGrantTypeEnabled)
		.append("dynamicRegistrationAllowedPasswordGrantScopes", this.dynamicRegistrationAllowedPasswordGrantScopes, obj.dynamicRegistrationAllowedPasswordGrantScopes)
		.append("dynamicRegistrationCustomObjectClass", this.dynamicRegistrationCustomObjectClass, obj.dynamicRegistrationCustomObjectClass)
		.append("personCustomObjectClassList", this.personCustomObjectClassList, obj.personCustomObjectClassList)
		.append("persistIdTokenInLdap", this.persistIdTokenInLdap, obj.persistIdTokenInLdap)
		.append("persistRefreshTokenInLdap", this.persistRefreshTokenInLdap, obj.persistRefreshTokenInLdap)
		.append("allowPostLogoutRedirectWithoutValidation", this.allowPostLogoutRedirectWithoutValidation, obj.allowPostLogoutRedirectWithoutValidation)
		.append("invalidateSessionCookiesAfterAuthorizationFlow", this.invalidateSessionCookiesAfterAuthorizationFlow, obj.invalidateSessionCookiesAfterAuthorizationFlow)
		.append("returnClientSecretOnRead", this.returnClientSecretOnRead, obj.returnClientSecretOnRead)
		.append("rejectJwtWithNoneAlg", this.rejectJwtWithNoneAlg, obj.rejectJwtWithNoneAlg)
		.append("expirationNotificatorEnabled", this.expirationNotificatorEnabled, obj.expirationNotificatorEnabled)
		.append("useNestedJwtDuringEncryption", this.useNestedJwtDuringEncryption, obj.useNestedJwtDuringEncryption)
		.append("expirationNotificatorMapSizeLimit", this.expirationNotificatorMapSizeLimit, obj.expirationNotificatorMapSizeLimit)
		.append("expirationNotificatorIntervalInSeconds", this.expirationNotificatorIntervalInSeconds, obj.expirationNotificatorIntervalInSeconds)
		.append("useCacheForAllImplicitFlowObjects", this.useCacheForAllImplicitFlowObjects, obj.useCacheForAllImplicitFlowObjects)
		.append("authenticationFiltersEnabled", this.authenticationFiltersEnabled, obj.authenticationFiltersEnabled)
		.append("clientAuthenticationFiltersEnabled", this.clientAuthenticationFiltersEnabled, obj.clientAuthenticationFiltersEnabled)
		.append("clientRegDefaultToCodeFlowWithRefresh", this.clientRegDefaultToCodeFlowWithRefresh, obj.clientRegDefaultToCodeFlowWithRefresh)
		.append("grantTypesAndResponseTypesAutofixEnabled", this.grantTypesAndResponseTypesAutofixEnabled, obj.grantTypesAndResponseTypesAutofixEnabled)
		.append("authenticationFilters", this.authenticationFilters, obj.authenticationFilters)
		.append("clientAuthenticationFilters", this.clientAuthenticationFilters, obj.clientAuthenticationFilters)
		.append("corsConfigurationFilters", this.corsConfigurationFilters, obj.corsConfigurationFilters)
		.append("sessionIdUnusedLifetime", this.sessionIdUnusedLifetime, obj.sessionIdUnusedLifetime)
		.append("sessionIdUnauthenticatedUnusedLifetime", this.sessionIdUnauthenticatedUnusedLifetime, obj.sessionIdUnauthenticatedUnusedLifetime) // 120 seconds
		.append("sessionIdPersistOnPromptNone", this.sessionIdPersistOnPromptNone, obj.sessionIdPersistOnPromptNone)
		.append("sessionIdRequestParameterEnabled", this.sessionIdRequestParameterEnabled, obj.sessionIdRequestParameterEnabled) // #1195
		.append("changeSessionIdOnAuthentication", this.changeSessionIdOnAuthentication, obj.changeSessionIdOnAuthentication)
		.append("sessionIdLifetime", this.sessionIdLifetime, obj.sessionIdLifetime)
		.append("serverSessionIdLifetime", this.serverSessionIdLifetime, obj.serverSessionIdLifetime)
		.append("configurationUpdateInterval", this.configurationUpdateInterval, obj.configurationUpdateInterval)
		.append("enableClientGrantTypeUpdate", this.enableClientGrantTypeUpdate, obj.enableClientGrantTypeUpdate)
		.append("dynamicGrantTypeDefault", this.dynamicGrantTypeDefault, obj.dynamicGrantTypeDefault)
		.append("cssLocation", this.cssLocation, obj.cssLocation)
		.append("jsLocation", this.jsLocation, obj.jsLocation)
		.append("imgLocation", this.imgLocation, obj.imgLocation)
		...
		.append("pairwiseIdType", this.pairwiseIdType, obj.pairwiseIdType) // persistent, algorithmic
		.append("pairwiseCalculationKey", this.pairwiseCalculationKey, obj.pairwiseCalculationKey)
		.append("pairwiseCalculationSalt", this.pairwiseCalculationSalt, obj.pairwiseCalculationSalt)
		.append("shareSubjectIdBetweenClientsWithSameSectorId", this.shareSubjectIdBetweenClientsWithSameSectorId, obj.shareSubjectIdBetweenClientsWithSameSectorId)
		.append("subjectIdentifierBasedOnWholeUriBackwardCompatibility", this.subjectIdentifierBasedOnWholeUriBackwardCompatibility, obj.subjectIdentifierBasedOnWholeUriBackwardCompatibility)
		.append("webKeysStorage", this.webKeysStorage, obj.webKeysStorage)
		.append("dnName", this.dnName, obj.dnName)
		.append("keyStoreFile", this.keyStoreFile, obj.keyStoreFile)
		.append("keyStoreSecret", this.keyStoreSecret, obj.keyStoreSecret)
		.append("keySelectionStrategy", this.keySelectionStrategy, obj.keySelectionStrategy)
		.append("keyAlgsAllowedForGeneration", this.keyAlgsAllowedForGeneration, obj.keyAlgsAllowedForGeneration)

		    //oxEleven
		.append("oxElevenTestModeToken", this.oxElevenTestModeToken, obj.oxElevenTestModeToken)
		.append("oxElevenGenerateKeyEndpoint", this.oxElevenGenerateKeyEndpoint, obj.oxElevenGenerateKeyEndpoint)
		.append("oxElevenSignEndpoint", this.oxElevenSignEndpoint, obj.oxElevenSignEndpoint)
		.append("oxElevenVerifySignatureEndpoint", this.oxElevenVerifySignatureEndpoint, obj.oxElevenVerifySignatureEndpoint)
		.append("oxElevenDeleteKeyEndpoint", this.oxElevenDeleteKeyEndpoint, obj.oxElevenDeleteKeyEndpoint)
		.append("introspectionAccessTokenMustHaveUmaProtectionScope", this.introspectionAccessTokenMustHaveUmaProtectionScope, obj.introspectionAccessTokenMustHaveUmaProtectionScope)
		.append("introspectionSkipAuthorization", this.introspectionSkipAuthorization, obj.introspectionSkipAuthorization)
		.append("endSessionWithAccessToken", this.endSessionWithAccessToken, obj.endSessionWithAccessToken)
		.append("cookieDomain", this.cookieDomain, obj.cookieDomain)
		.append("enabledOAuthAuditLogging", this.enabledOAuthAuditLogging, obj.enabledOAuthAuditLogging)
		.append("jmsBrokerURISet", this.jmsBrokerURISet, obj.jmsBrokerURISet)
		.append("jmsUserName", this.jmsUserName, obj.jmsUserName)
		.append("jmsPassword", this.jmsPassword, obj.jmsPassword)
		...
		.append("legacyIdTokenClaims", this.legacyIdTokenClaims, obj.legacyIdTokenClaims)
		.append("customHeadersWithAuthorizationResponse", this.customHeadersWithAuthorizationResponse, obj.customHeadersWithAuthorizationResponse)
		.append("frontChannelLogoutSessionSupported", this.frontChannelLogoutSessionSupported, obj.frontChannelLogoutSessionSupported)
		.append("loggingLevel", this.loggingLevel, obj.loggingLevel)
		.append("loggingLayout", this.loggingLayout, obj.loggingLayout)
		.append("updateUserLastLogonTime", this.updateUserLastLogonTime, obj.updateUserLastLogonTime)
		.append("updateClientAccessTime", this.updateClientAccessTime, obj.updateClientAccessTime)
		.append("logClientIdOnClientAuthentication", this.logClientIdOnClientAuthentication, obj.logClientIdOnClientAuthentication)
		.append("logClientNameOnClientAuthentication", this.logClientNameOnClientAuthentication, obj.logClientNameOnClientAuthentication)
		.append("disableJdkLogger", this.disableJdkLogger, obj.disableJdkLogger)
		.append("authorizationRequestCustomAllowedParameters", this.authorizationRequestCustomAllowedParameters, obj.authorizationRequestCustomAllowedParameters)
		.append("legacyDynamicRegistrationScopeParam", this.legacyDynamicRegistrationScopeParam, obj.legacyDynamicRegistrationScopeParam)
		.append("openidScopeBackwardCompatibility", this.openidScopeBackwardCompatibility, obj.openidScopeBackwardCompatibility)
		.append("disableU2fEndpoint", this.disableU2fEndpoint, obj.disableU2fEndpoint)
		.append("useLocalCache", this.useLocalCache, obj.useLocalCache)
		.append("fapiCompatibility", this.fapiCompatibility, obj.fapiCompatibility)
		.append("forceIdTokenHintPrecense = false", this.forceIdTokenHintPrecense, obj.forceIdTokenHintPrecense)
		.append("rejectEndSessionIfIdTokenExpired = false", this.rejectEndSessionIfIdTokenExpired, obj.rejectEndSessionIfIdTokenExpired)
		.append("allowEndSessionWithUnmatchedSid = false", this.allowEndSessionWithUnmatchedSid, obj.allowEndSessionWithUnmatchedSid)
		.append("forceOfflineAccessScopeToEnableRefreshToken = true", this.forceOfflineAccessScopeToEnableRefreshToken, obj.forceOfflineAccessScopeToEnableRefreshToken)
		.append("errorReasonEnabled  = false", this.errorReasonEnabled, obj.errorReasonEnabled)
		.append("removeRefreshTokensForClientOnLogout  = true", this.removeRefreshTokensForClientOnLogout, obj.removeRefreshTokensForClientOnLogout)
		.append("skipRefreshTokenDuringRefreshing  = false", this.skipRefreshTokenDuringRefreshing, obj.skipRefreshTokenDuringRefreshing)
		.append("refreshTokenExtendLifetimeOnRotation  = false", this.refreshTokenExtendLifetimeOnRotation, obj.refreshTokenExtendLifetimeOnRotation)
		.append("checkUserPresenceOnRefreshToken = false", this.checkUserPresenceOnRefreshToken, obj.checkUserPresenceOnRefreshToken)
		.append("consentGatheringScriptBackwardCompatibility = false", this.consentGatheringScriptBackwardCompatibility, obj.consentGatheringScriptBackwardCompatibility)
		.append("introspectionScriptBackwardCompatibility = false", this.introspectionScriptBackwardCompatibility, obj.introspectionScriptBackwardCompatibility)
		.append("introspectionResponseScopesBackwardCompatibility = false", this.introspectionResponseScopesBackwardCompatibility, obj.introspectionResponseScopesBackwardCompatibility) // See #1499
		.append("clientAuthorizationBackwardCompatibility = false", this.clientAuthorizationBackwardCompatibility, obj.clientAuthorizationBackwardCompatibility)
		.append("softwareStatementValidationType", this.softwareStatementValidationType, obj.softwareStatementValidationType)
		.append("softwareStatementValidationClaimName", this.softwareStatementValidationClaimName, obj.softwareStatementValidationClaimName)
		.append("authenticationProtectionConfiguration", this.authenticationProtectionConfiguration, obj.authenticationProtectionConfiguration)
		.append("errorHandlingMethod = ErrorHandlingMethod.INTERNAL", this.errorHandlingMethod, obj.errorHandlingMethod)
		.append("keepAuthenticatorAttributesOnAcrChange = false", this.keepAuthenticatorAttributesOnAcrChange, obj.keepAuthenticatorAttributesOnAcrChange)
		.append("disableAuthnForMaxAgeZero = false", this.disableAuthnForMaxAgeZero, obj.disableAuthnForMaxAgeZero)
		.append("deviceAuthzRequestExpiresIn", this.deviceAuthzRequestExpiresIn, obj.deviceAuthzRequestExpiresIn)
		.append("deviceAuthzTokenPollInterval", this.deviceAuthzTokenPollInterval, obj.deviceAuthzTokenPollInterval)
		.append("deviceAuthzResponseTypeToProcessAuthz", this.deviceAuthzResponseTypeToProcessAuthz, obj.deviceAuthzResponseTypeToProcessAuthz)

		 // CIBA
		.append("backchannelClientId", this.backchannelClientId, obj.backchannelClientId)
		.append("backchannelRedirectUri", this.backchannelRedirectUri, obj.backchannelRedirectUri)
		.append("backchannelAuthenticationEndpoint", this.backchannelAuthenticationEndpoint, obj.backchannelAuthenticationEndpoint)
		.append("backchannelDeviceRegistrationEndpoint", this.backchannelDeviceRegistrationEndpoint, obj.backchannelDeviceRegistrationEndpoint)
		.append("backchannelTokenDeliveryModesSupported", this.backchannelTokenDeliveryModesSupported, obj.backchannelTokenDeliveryModesSupported)
		.append("backchannelAuthenticationRequestSigningAlgValuesSupported", this.backchannelAuthenticationRequestSigningAlgValuesSupported, obj.backchannelAuthenticationRequestSigningAlgValuesSupported)
		.append("backchannelUserCodeParameterSupported", this.backchannelUserCodeParameterSupported, obj.backchannelUserCodeParameterSupported)
		.append("backchannelBindingMessagePattern", this.backchannelBindingMessagePattern, obj.backchannelBindingMessagePattern)
		.append("backchannelAuthenticationResponseExpiresIn", this.backchannelAuthenticationResponseExpiresIn, obj.backchannelAuthenticationResponseExpiresIn)
		.append("backchannelAuthenticationResponseInterval", this.backchannelAuthenticationResponseInterval, obj.backchannelAuthenticationResponseInterval)
		.append("backchannelLoginHintClaims", this.backchannelLoginHintClaims, obj.backchannelLoginHintClaims)
		.append("cibaEndUserNotificationConfig", this.cibaEndUserNotificationConfig, obj.cibaEndUserNotificationConfig)
		.append("backchannelRequestsProcessorJobIntervalSec", this.backchannelRequestsProcessorJobIntervalSec, obj.backchannelRequestsProcessorJobIntervalSec)
		.append("backchannelRequestsProcessorJobChunkSize", this.backchannelRequestsProcessorJobChunkSize, obj.backchannelRequestsProcessorJobChunkSize)
		.append("cibaGrantLifeExtraTimeSec", this.cibaGrantLifeExtraTimeSec, obj.cibaGrantLifeExtraTimeSec)
		.append("cibaMaxExpirationTimeAllowedSec", this.cibaMaxExpirationTimeAllowedSec, obj.cibaMaxExpirationTimeAllowedSec)
		.append("cibaEnabled", this.cibaEnabled, obj.cibaEnabled)
		.build();
	}
}