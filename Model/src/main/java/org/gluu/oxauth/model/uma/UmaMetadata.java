...
public class UmaMetadata extends OAuth2Discovery {
    ...
    @Schema(required = false, description = "UMA profiles supported by this authorization server. The value is an array of string values, where each string value is a URI identifying an UMA profile")
    @JsonProperty(value = "uma_profiles_supported")
    @XmlElement(name = "uma_profiles_supported")
    private String[] umaProfilesSupported;

    @Schema(required = true, description = "The endpoint URI at which the resource server requests permissions on the client's behalf.")
    @JsonProperty(value = "permission_endpoint")
    @XmlElement(name = "permission_endpoint")
    private String permissionEndpoint;

    @Schema(required = true, description = "The endpoint URI at which the resource server registers resources to put them under authorization manager protection.")
    ...
    @Schema(required = true, description = "The Scope endpoint URI.")
