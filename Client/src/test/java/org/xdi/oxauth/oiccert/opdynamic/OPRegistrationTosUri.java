 ...
 */
public class OPRegistrationTosUri extends BaseTest {

    @Parameters({"redirectUris", "postLogoutRedirectUri", "clientJwksUri", "redirectUri"})
    @Test
    public void opRegistrationTosUri(
        ...
        System.out.println("#######################################################");
        System.out.println("Test ID: OP-Registration-tos_uri");
        System.out.println("Test description: Registration with tos_uri [Dynamic]");
        System.out.println("#######################################################");

        // 1. Dynamic Registration
        List<ResponseType> responseTypes = Arrays.asList(ResponseType.CODE);
        String tosUri = "http://www.gluu.org/tos";
        ...
        registerRequest.setTosUri(tosUri);
        ...
        try {
            ...
            WebElement tos = driver.findElement(By.xpath("//a[@href='" + tosUri + "']"));
            assertNotNull(tos);
