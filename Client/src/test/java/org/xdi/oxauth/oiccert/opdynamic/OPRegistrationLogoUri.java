 ...
 */
public class OPRegistrationLogoUri extends BaseTest {

    @Parameters({"redirectUris", "postLogoutRedirectUri", "clientJwksUri", "redirectUri"})
    @Test
    public void opRegistrationLogoUri(
        ...
        System.out.println("#######################################################");
        System.out.println("Test ID: OP-Registration-logo_uri");
        System.out.println("Test description: Registration with logo_uri [Dynamic]");
        System.out.println("#######################################################");
