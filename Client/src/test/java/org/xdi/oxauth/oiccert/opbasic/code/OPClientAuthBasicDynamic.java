 ...
 */
public class OPClientAuthBasicDynamic extends BaseTest {

    @Parameters({"redirectUris", "postLogoutRedirectUri", "clientJwksUri", "userId", "userSecret", "redirectUri"})
    @Test
    public void opClientAuthBasicDynamic(
        ...
        System.out.println("#######################################################");
        System.out.println("Test ID: OP-ClientAuth-Basic-Dynamic");
        System.out.println("Test description: Access token request with client_secret_basic authentication [Basic, Hybrid]");
        System.out.println("#######################################################");
