...
public interface TokenRestWebService {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(code = 400, message = " invalid_scope\n" +
                    ...
                    " resource owner."),
            @ApiResponse(code = 401, message = "authorization_pending\n" +
                    "The authorization request is still pending as the end-user hasn't yet visited the" +
                    " authorization server and entered their verification code."),
            @ApiResponse(code = 401, message = "slow_down\n" +
                    "The client is polling too quickly and should back off at a reasonable rate."),
            @ApiResponse(code = 400, message = "expired_token\n" +
